_base_ = [
    ...
    '../_base_/datasets/train_dataset_for_students_c.py',
...
# python3.10 tools/train.py /home/ubuntu/SPR_6_PETROV_E/mmsegmentation/configs/unet_train_ds_1/unet_train_1_256x256.py 