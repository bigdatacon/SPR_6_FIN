...
def train_dataset_for_students_c_classes():
    return [
        "background", "cat", "dog"
    ]


def train_dataset_for_students_c_palette():
    return [[0, 0, 0], [255, 0, 0], [0, 255, 0]]


def train_dataset_for_students_fin_classes():
    return [
        "background", "cat", "dog"
    ]


def train_dataset_for_students_fin_palette():
    return [[0, 0, 0], [255, 0, 0], [0, 255, 0]]